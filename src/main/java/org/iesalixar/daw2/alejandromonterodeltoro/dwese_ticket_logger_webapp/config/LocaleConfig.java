...
public class LocaleConfig implements WebMvcConfigurer {
    ...
    /**
     * Define el `LocaleResolver` que se usará para almacenar la configuración
     de idioma del usuario.
     * En este caso, utilizamos `SessionLocaleResolver` para almacenar el idioma
     en la sesión.
     *
     * @return una instancia de `SessionLocaleResolver` con el idioma
    ...
    /**
     * Registra el `LocaleChangeInterceptor` para que se aplique a todas las
     solicitudes.
