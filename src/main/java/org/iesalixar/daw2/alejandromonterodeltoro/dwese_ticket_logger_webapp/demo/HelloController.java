...
public class HelloController {
     ...
     * Este método recibe un parámetro opcional "name" y devuelve un saludo
     personalizado.
     *
     * @param name Parámetro opcional que representa el nombre a saludar. Si no
    se pasa, por defecto es "World".
     * @return Una cadena de texto con el saludo personalizado.
     */
    @GetMapping("/hello")
    // Hacemos una variable name y si no introduces en la URL nada se pone por defecto mundo
    public String hello(@RequestParam(value = "name", defaultValue = "World") String name) {
        // Loguea cuando el mtodo hello es llamado, mostrando el nombre recibido
